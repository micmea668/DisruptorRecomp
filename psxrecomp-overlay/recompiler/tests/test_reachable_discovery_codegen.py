...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp:
        # Keep find_project_root() anchored to this fixture. Some CI/sandbox
        # hosts place a repository marker in the shared temp parent, which
        # would otherwise make relative test.exe/seeds.txt paths resolve one
        # directory too high and turn this into an environment-dependent test.
        pathlib.Path(tmp, ".gitignore").write_text("\n", encoding="utf-8")
