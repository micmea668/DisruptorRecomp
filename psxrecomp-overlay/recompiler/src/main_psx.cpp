...
int main(int argc, char** argv) {
    ...
    std::set<uint32_t>    ws_cull_lower_branch; // [widescreen.cull] lower_branch_sites
    std::set<uint32_t>    ws_cull_lower_value;  // [widescreen.cull] lower_value_sites
    std::set<uint32_t>    ws_cull_upper_value;  // [widescreen.cull] upper_value_sites
    std::set<uint32_t>    ws_cull_span_value;   // [widescreen.cull] span_value_sites
    ...
    std::vector<PSXRecompV4::WidescreenYawConeSite> ws_cull_yaw_cone;
    std::vector<PSXRecompV4::WidescreenHorizontalSltSite>
        ws_cull_horizontal_slt;
    ...
    if (!config_path.empty()) {
        ...
        ws_cull_lower_branch.insert(cfg.ws_cull_lower_branch_sites.begin(),
                                    cfg.ws_cull_lower_branch_sites.end());
        ws_cull_lower_value.insert(cfg.ws_cull_lower_value_sites.begin(),
                                   cfg.ws_cull_lower_value_sites.end());
        ws_cull_upper_value.insert(cfg.ws_cull_upper_value_sites.begin(),
                                   cfg.ws_cull_upper_value_sites.end());
        ws_cull_span_value.insert(cfg.ws_cull_span_value_sites.begin(),
                                  cfg.ws_cull_span_value_sites.end());
        ...
        ws_cull_yaw_cone = cfg.ws_cull_yaw_cone_sites;
        ws_cull_horizontal_slt = cfg.ws_cull_horizontal_slt_sites;
    ...
    if (!ws_config_path.empty()) {
        ...
        ws_cull_lower_branch.insert(wscfg.ws_cull_lower_branch_sites.begin(),
                                    wscfg.ws_cull_lower_branch_sites.end());
        ws_cull_lower_value.insert(wscfg.ws_cull_lower_value_sites.begin(),
                                   wscfg.ws_cull_lower_value_sites.end());
        ws_cull_upper_value.insert(wscfg.ws_cull_upper_value_sites.begin(),
                                   wscfg.ws_cull_upper_value_sites.end());
        ws_cull_span_value.insert(wscfg.ws_cull_span_value_sites.begin(),
                                  wscfg.ws_cull_span_value_sites.end());
        ...
        if (ws_cull_yaw_cone.empty())
            ws_cull_yaw_cone = wscfg.ws_cull_yaw_cone_sites;
        if (ws_cull_horizontal_slt.empty())
            ws_cull_horizontal_slt =
                wscfg.ws_cull_horizontal_slt_sites;
    ...
    codegen_config.ws_cull_lower_branch_sites = ws_cull_lower_branch;
    codegen_config.ws_cull_lower_value_sites = ws_cull_lower_value;
    codegen_config.ws_cull_upper_value_sites = ws_cull_upper_value;
    codegen_config.ws_cull_span_value_sites = ws_cull_span_value;
    ...
    codegen_config.ws_cull_yaw_cone_sites = ws_cull_yaw_cone;
    codegen_config.ws_cull_horizontal_slt_sites =
        ws_cull_horizontal_slt;
